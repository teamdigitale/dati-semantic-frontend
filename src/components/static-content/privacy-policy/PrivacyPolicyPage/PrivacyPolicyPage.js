      ...
      <div data-testid="PrivacyPolicyBody" className="policy-body container">
        <div className="ml-5 pl-5 pt-5">
          ...
          <p>
            ...
            dell’art. 13 del Regolamento (UE) 2016/679 (di seguito Regolamento)
            e hanno l’obiettivo di descrivere le modalità di trattamento dei
            dati personali degli utenti che consultano esclusivamente il
            presente sito e che afferiscono soltanto ai cookie utilizzati.
            Infatti{" "}
            <Anchor href="https://www.schema.gov.it">www.schema.gov.it</Anchor>{" "}
            non contiene altri dati personali diversi da questi.
          </p>
          <ContentParagraph title="Titolare del trattamento">
            Titolare del Trattamento è la Presidenza del Consiglio dei Ministri
            - Dipartimento per la Trasformazione Digitale, con sede in Largo
            Pietro di Brazzà 86, 00187 Roma contattabile ai seguenti recapiti:
            <div className="pt-4">
              <ul>
                <li>
                  Email:{" "}
          ...
          <ContentParagraph title="Base giuridica del trattamento">
            ...
            <p>
              ...
              nell’esecuzione dei compiti di interesse pubblico ad esso affidati
              in attuazione dell’Intervento Catalogo Nazionale Dati
              “Progettazione, creazione e attuazione di un catalogo centrale (in
              open data, secondo i principi del Quadro10 europeo di
          ...
          <ContentParagraph title="Dati trattati e finalità del trattamento">
            ...
            <p>
              ...
              anche trattati allo scopo di controllare il corretto funzionamento
              dei servizi offerti.
            </p>
            ...
            <p>
              ...
              esposti si rimanda alle informazioni da questi rese attraverso le
              rispettive privacy policy. La Presidenza del Consiglio non tratta
              eventuali dati personali conferiti dall’utenza attraverso tali
              software.
            </p>
          </ContentParagraph>
          <ContentParagraph title="Soggetti che possono venire a conoscenza dei dati o ai quali gli stessi possono essere comunicati">
            <p>
              ...
              Consiglio o i collaboratori, anche esterni, che forniscono servizi
              strumentali alle finalità sopra indicate (es. servizi tecnici);
              tali soggetti agiranno in qualità di Soggetti autorizzati a
              trattare i dati (art. 29 Reg. (UE) 2016/679) o di Responsabili del
              trattamento (art. 28 Reg. (UE) 2016/679).
            </p>
          </ContentParagraph>
          <ContentParagraph title="Diritti degli interessati">
            <p>
              Gli interessati hanno il diritto di ottenere dalla Presidenza del
              Consiglio, nei casi previsti, l’accesso ai propri dati personali e
              la rettifica o la cancellazione degli stessi o la limitazione del
              trattamento che li riguarda o di opporsi al trattamento (artt. 15
              e ss. del Regolamento), scrivendo ai contatti di riferimento del
              Responsabile della Protezione Dati sopra menzionati.
            </p>
          </ContentParagraph>
          <ContentParagraph title="Diritto di reclamo">
            <p>
              ...
              le opportune sedi giudiziarie (art. 79 del Regolamento stesso).
            </p>
          </ContentParagraph>
        </div>
      </div>
